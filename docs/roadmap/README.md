...
| 3 | [phase-3-auto-import.md](phase-3-auto-import.md) | "Matched by ID" auto-import (Sonarr + Radarr) | 2a | v1.8.0 | ⏳ next |
| 4 | [phase-4-env-example.md](phase-4-env-example.md) | Improve `.env.example` | 2b | v1.8.1 | |
| 5 | [phase-5-alert-e2e.md](phase-5-alert-e2e.md) | Alert webhook end-to-end test | 2c | v1.8.2 | |
